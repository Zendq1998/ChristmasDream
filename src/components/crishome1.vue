    ...
    <div class="full_width full_hight background">
        ...
        <transition name="fade">
            <div class="smallgift one" v-if="word>=1" @click="chose(1)">
                <img v-bind:class="{ bouncea: move}" src="../pictures/gift1.png" v-if="chosed == 1 ">
            </div>
        </transition>
        <transition name="fade">
            <div class="smallgift two" v-if="word>=1" @click="chose(2)">
                <img v-bind:class="{ bounceb: move}" src="../pictures/gift2.png" v-if="chosed == 1 ">
            </div>
        </transition>
        <transition name="fade">
            <div class="smallgift three" v-if="word>=1" @click="chose(3)">
                <img v-bind:class="{ bouncec: move}" src="../pictures/gift3.png" v-if="chosed == 1 ">
            </div>
        </transition>
        <transition name="fade">
            <div class="smallgift four" v-if="word>=1" @click="chose(4)">
                <img v-bind:class="{ bounced: move}" src="../pictures/gift4.png" v-if="chosed == 1 ">
            </div>
        </transition>
        ...
        <transition name="fade">
            <div class="santa-speak" v-if="word==6">
                <p>看看是啥</p>
            </div>
        </transition>    
